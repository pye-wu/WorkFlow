 	...
 	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		        <td height="20" bgcolor="#FFFFFF" class="STYLE10" colspan="8"><div align="left">
					<a href="${pageContext.request.contextPath }/la_execute_input">添加请假申请</a>
				</div></td>
		  </tr> 
		  <tr>
		      	...
		      	<s:iterator value="#leavelist">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<s:if test="state==0">
			        			<a href="${pageContext.request.contextPath }/la_getleaveByID_input?id=<s:property value="id"/>" >修改</a>
								<a href="la_deleteleaveById_list?id=<s:property value="id"/>" >删除</a>
								<a href="${pageContext.request.contextPath }/w_startProcess_list?id=<s:property value="id"/>" >申请请假</a>
			        		</s:if>
			 				<s:elseif test="state==1">
